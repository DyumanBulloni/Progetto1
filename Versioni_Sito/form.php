		...
		<div class = "form">
			...
			<table style="width:100%">
				...
				<tr>
					...
					<td><input required onkeyup="controlData(this.value, 'text', 'lSit')" type="text" id="slCampoScuolaProf" name="lScuola" placeholder="Scuola"></td>
...
o Che cosa ti aspettavi ma non hai trovato?"></textarea></td>
		...
		function studentOrWorker(a){
			...
			if(a == "Studente"){
				...
				document.getElementById("slSedeTipo").innerHTML = "Sede";
				text = "text";
				sT = "lSedeTipo";
				document.getElementById("cellaTipo").innerHTML = "<input required onkeyup='controlData(this.value, text, lSedeTipo)' type='text' id='slCampoSede' name='lSedeTipo' placeholder='Sede'>";
			}else if(a == "Lavoro"){
